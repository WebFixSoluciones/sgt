...
export const initialCampaigns: EvaluationCampaign[] = [
  ...
  {
    id: 'camp-16',
    code: 'NOCTURNO-CORP-HHSS',
    title: 'ENCUESTA DE TRABAJO NOCTURNO CORP. HH.SS.CC.',
    company: 'CORP. HH.SS.CC.',
    formId: 'form-trabajo-nocturno',
    formIds: ['form-trabajo-nocturno'],
  ...
  },
  {
    id: 'camp-15',
    code: 'NOCTURNO-CPTDC',
    title: 'ENCUESTA DE TRABAJO NOCTURNO CPTDC ECUADOR S.A',
    company: 'CPTDC ECUADOR S.A',
    formId: 'form-trabajo-nocturno',
    formIds: ['form-trabajo-nocturno'],
